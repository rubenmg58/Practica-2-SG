...
class Crane extends THREE.Object3D {
  ...
  constructor (parameters) {
    ...
    //this.material    = (parameters.material === undefined ? new THREE.MeshPhongMaterial ({color: 0x8a4b08, specular: 0xffffff, shininess: 70}) : parameters.material);
    var loader = new THREE.TextureLoader();
    var textura = loader.load ("imgs/twitter.jpeg");
  ...
  createBase () {
    var base = new THREE.Mesh (
      new THREE.BoxGeometry (10, 1, 10, 16, 1),
                               this.material);
  ...
  createTrolleyStringHook () {
    ...
    this.string = new THREE.Mesh (
      new THREE.CylinderGeometry (0.5, 0.5, 1), this.material);
